...
import QuoteImg from "../multimedia/CreateQuote.png";
...
const Home: React.FC = () => {
    ...
    const output = async() => {
        axios.get('/quote/list').then(response => setQuotes(response.data))
    }
    output();
    ...
    return (
        <div style={{ fontFamily: 'Poppins' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '50% 50%' }}>
                ...
                <div>
                    <Quote score={158} quote={'Twenty years from now you will be more disappointed by the things that you didnt do than by the ones you did do. So throw off the bowlines. Sail away from the safe harbor. Catch the trade winds in your sails. Explore. Dream. Discover.'} author={'Janez Novak'} />
                </div>
            </div>
